            ...
            <Header icon>
              <Icon>
                <Image
                  ...
                  centered
                  style={{ width: "30vw", maxWidth: "200px", marginTop: 80 }}
                />
              </Icon>
          ...
          >
            <Grid reversed="computer" columns="equal">
              {gameDataMain.map((game, i) => {
                if (i < 2)
                  return (
                    <Grid.Column key={game} only="computer tablet">
                      <GameBox
                        game={game}
                        trigger="hover"
                        stroke="10"
                ...
                <Grid.Column mobile={16} tablet={10} computer={10}>
                  <div className="farsi">
                    ...
                    <p className="lh-base">
                      ...
                      اطلاعات شما را محافظت می کنیم. بنابراین، با اطمینان کامل
                      می توانید بازی کنید و لذت ببرید.
                    </p>
                  </div>
                  <br />
                  <Segment.Inline className="text-end">
                ...
                <Grid.Column mobile={16} tablet={10} computer={10}>
                  <div className="farsi">
                    ...
                    <p className="lh-base">
                      ...
                      ایرانی خرید و فروش اتوماتیک ووچر پرفکت مانی ، اقدام به
                      خرید ووچر کرده و کد ووچرتان را در صفحه دیپازیت سایت وارد
                      کنید تا بلافاصله اکانتتان معادل رقم آن ووچر شارژ گردد.
                      علاوه بر آن می توانید از بیت کوین برای بازی پوکر آنلاین
                      استفاده کنید.
                    </p>
                    <p className="lh-base">
                      در هنگام کشوت از گلکسی کازینو هم بسته به گزینه انتخابی تان
                      یا به صورت واریز شتاب به کارت بانکی تان پرداخت صورت می
                      گیرد و یا معادل رقم درخواستی جهت برداشت یک ووچر در صفحه
                      تراکنش تان به شما داده می شود.
                    </p>
                  </div>
                  <br />
                  <Segment.Inline className="text-end">
