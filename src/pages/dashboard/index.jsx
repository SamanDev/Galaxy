          ...
          <Grid.Column mobile={16} tablet={10} computer={10}>
            <div className="farsi">
              ...
              <p className="lh-base">
                ...
                تگزاس هولدم، اوماها، سوپر ستود و... دسترسی پیدا کنید. همچنین، با
                شرکت در مسابقات و رقابت های مختلف، می توانید به عنوان یک بازیکن
                حرفه ای در پوکر به شهرت و پول برسید.
              </p>
              <p className="lh-base">
                در گلکسی کازینو، امنیت شما برای ما بسیار مهم است و به همین دلیل،
                با استفاده از فناوری های پیشرفته از جمله رمزنگاری، اطلاعات شما
                را محافظت می کنیم. بنابراین، با اطمینان کامل می توانید بازی کنید
                و لذت ببرید.
              </p>
            </div>
            <br />
          ...
          <Grid.Column mobile={16} tablet={10} computer={10}>
            <div className="farsi">
              ...
              <p className="lh-base">
                ...
                اتوماتیک ووچر پرفکت مانی ، اقدام به خرید ووچر کرده و کد ووچرتان
                را در صفحه دیپازیت سایت وارد کنید تا بلافاصله اکانتتان معادل رقم
                آن ووچر شارژ گردد. علاوه بر آن می توانید از بیت کوین برای بازی
                پوکر آنلاین استفاده کنید.
              </p>
              <p className="lh-base">
                ...
                رقم درخواستی جهت برداشت یک ووچر در صفحه تراکنش تان به شما داده
                می شود.
              </p>
            </div>
            <br />
