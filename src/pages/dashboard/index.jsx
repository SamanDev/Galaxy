        ...
        <Grid reversed="computer tablet">
          <Grid.Column mobile={16} tablet={10} computer={10}>
            <div className="farsi">
              ...
              <p className="lh-base">
                پوکر بازی محبوب جوانان با پاستور میباشد , بازی پوکر دو نفره تا
                10 نفره امکان پذیر است. رده سنی بازی پوکر 18 تا 99 سال می باشد.
                شما می توانید بازی پوکر را به صورت آنلاین در سایت گلکسی کازینو
                بازی کنید و از طریق درگاه برداشت کنید.
              </p>
            </div>
            <br />
